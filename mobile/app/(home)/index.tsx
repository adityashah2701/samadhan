  ...
  useEffect(() => {
    const syncUser = async () => {
      if (isLoaded && user && !convexUser) {
        try {
          const provider = user.externalAccounts && user.externalAccounts.length > 0 
    ...
    syncUser()
  }, [isLoaded, user?.id, convexUser, createOrUpdateUser])
          ...
          <View style={styles.header}>
            <View style={styles.headerContent}>
              <View style={styles.headerLeft}>
                ...
                <View>
                  <Text style={styles.appName}>Jharkhand Civic Portal</Text>
            ...
            >
              <View style={styles.statCard}>
                ...
                >
                  ...
                  <Text style={styles.statNumber}>{formatNumber(convexUser.stats.totalIssues)}</Text>
              ...
              <View style={styles.statCard}>
                ...
                >
                  ...
                  <Text style={styles.statNumber}>{formatNumber(convexUser.stats.pendingIssues)}</Text>
              ...
              <View style={styles.statCard}>
                ...
                >
                  ...
                  <Text style={styles.statNumber}>{formatNumber(convexUser.stats.resolvedIssues)}</Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.communityStatsGrid}>
              <View style={styles.communityStatCard}>
                ...
                <Text style={styles.communityStatNumber}>{formatNumber(issueStats.total)}</Text>
              ...
              <View style={styles.communityStatCard}>
                ...
                <Text style={styles.communityStatNumber}>{formatNumber(issueStats.inProgress)}</Text>
              ...
              <View style={styles.communityStatCard}>
                ...
                <Text style={styles.communityStatNumber}>{formatNumber(issueStats.resolved)}</Text>
                ...
                <View style={styles.issueCardContent}>
                  <View style={styles.issueHeader}>
                    ...
                    <View style={styles.categoryTag}>
                      <Text style={styles.categoryTagText}>{issue.category}</Text>
                    </View>
                  </View>
